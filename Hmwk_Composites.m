...
%Compute the Strains
for i=1:3
eps_0deg(:,i) = Trans_mat0*[eps_x(i); eps_y(i); gamm_xy(i)/2];
eps_90deg(:,i) = Trans_mat90*[eps_x(i); eps_y(i); gamm_xy(i)/2];
end
%(d) Compute stresses in principal system
Stress_0deg = Trans_mat0*StressValues1(:,1);
sigma1_0 = Stress_0deg(1); sigma2_0 = Stress_0deg(2); tau12_0 = Stress_0deg(3);
Stress_90deg = Trans_mat90*StressValues2(:,1);
sigma1_90 = Stress_90deg(1); sigma2_90 = Stress_90deg(2); tau12_90 = Stress_90deg(3);
